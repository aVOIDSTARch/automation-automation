...
- My ultimate goal is to also be able to build automations using a language that is as common and accessible as HTML but can be combined like Legos to build huge projects in seconds or minutes in a drag and drop way. 
